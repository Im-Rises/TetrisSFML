...
#include <SFML/Graphics/Glsl.inl>
	...
	namespace Glsl {
		...
		////////////////////////////////////////////////////////////
		/// \brief 3x3 float tiles (\p mat3 in GLSL)
		///
		/// The tiles can be constructed from an array with 3x3
		...
		/// };
		///
		/// sf::Glsl::Mat3 tiles(array);
		/// \endcode
		///
		/// Mat3 can also be implicitly converted from sf::Transform:
		/// \code
		/// sf::Transform transform;
		/// sf::Glsl::Mat3 tiles = transform;
		/// \endcode
		////////////////////////////////////////////////////////////
		typedef implementation - defined Mat3;

		////////////////////////////////////////////////////////////
		/// \brief 4x4 float tiles (\p mat4 in GLSL)
		///
		/// The tiles can be constructed from an array with 4x4
		/// elements, aligned in column-major order. For example,
...
/// x, y, z, and w.
///
/// All tiles types support a constructor with a float*
/// parameter that points to a float array of the appropriate
/// size (that is, 9 in a 3x3 tiles, 16 in a 4x4 tiles).
