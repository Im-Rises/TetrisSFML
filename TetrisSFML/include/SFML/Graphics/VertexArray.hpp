...
/// Example:
/// \code
/// sf::VertexArray linesCounter(sf::LineStrip, 4);
/// linesCounter[0].position = sf::Vector2f(10, 0);
/// linesCounter[1].position = sf::Vector2f(20, 0);
/// linesCounter[2].position = sf::Vector2f(30, 5);
/// linesCounter[3].position = sf::Vector2f(40, 2);
///
/// window.draw(linesCounter);
/// \endcode
///
/// \see sf::Vertex
///
