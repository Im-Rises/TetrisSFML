...
namespace sf {
	...
	public:
		...
		////////////////////////////////////////////////////////////
		/// \brief Specify value for \p mat3 tiles
		///
		/// \param name   Name of the uniform variable in GLSL
		/// \param matrix Value of the mat3 tiles
		///
		////////////////////////////////////////////////////////////
		void setUniform(const std::string& name, const Glsl::Mat3& matrix);

		////////////////////////////////////////////////////////////
		/// \brief Specify value for \p mat4 tiles
		///
		/// \param name   Name of the uniform variable in GLSL
		/// \param matrix Value of the mat4 tiles
		///
		////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////
		/// \brief Change a tiles parameter of the shader
		///
...
/// shader.setUniform("tiles", sf::Glsl::Mat4(transform));     // transform is a sf::Transform
